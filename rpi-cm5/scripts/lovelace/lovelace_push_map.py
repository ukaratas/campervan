    ...
    async with websockets.connect(WS_URI, max_size=2**22, ping_interval=20, open_timeout=15) as ws:
        ...
        systems_view = _area_view(
            ...
            [
                ...
                {"type": "heading", "heading": "Indoor environment"},
                _info_tile("sensor.cv_sensors_01_indoor_temperature", "Indoor temperature", "mdi:thermometer"),
                _info_tile("sensor.cv_sensors_01_indoor_humidity", "Indoor humidity", "mdi:water-percent"),
                _info_tile("sensor.cv_sensors_01_pressure", "Pressure", "mdi:gauge"),
            ...
            "sections": [
                ...
                },
                {
                    ...
                    "cards": [
                        ...
                        {
                            "type": "tile",
                            "entity": "sensor.cv_sensors_01_indoor_temperature",
                            "name": "Indoor temp",
                            "icon": "mdi:thermometer",
                        },
                        {
                            "type": "tile",
                            "entity": "sensor.cv_sensors_01_indoor_humidity",
