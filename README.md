...
- 📹 [**Güvenlik ve İzleme**](Areas/surveillance.md): Hikvision DS-M5504HM-T 4 kanal Mobile DVR, 4x analog TVI kamera (720p, IR gece görüş, aviation konnektör) ile ön/arka/sol/sağ tam çevre izleme, Ethernet üzerinden HA entegrasyonu, park/seyir/kamp modları, hareket algılama.
...
| Banyo                       | 🟢 Detaylandı | 90%        |
| Güvenlik ve İzleme          | 🟢 Detaylandı | 90%        |
...
│   ├── banyo.md               # Banyo
│   ├── surveillance.md        # Güvenlik ve izleme sistemi (4 kamera + DVR)
