...
- 💧 [**Temiz Su Sistemi**](Areas/clean-water.md): 150L depo, RS485/analog seviye sensörü, otomatik drenaj, donma koruması, 24V pompa ve genleşme kabı, Home Assistant ile izleme ve otomasyon.
- 🤖 [**Otomasyon & Kontrol Altyapısı**](Areas/automation.md): Raspberry Pi CM4, endüstriyel Waveshare IoT modülleri, Modbus röleler ve analog girişler ile Home Assistant tabanlı merkezi otomasyon ve izleme altyapısı.
- 🔥 [**Isıtma Sistemi**](Areas/heating.md): Eberspacher D4L 4kW 24V dizel hava ısıtıcısı, otomasyon ve Home Assistant entegrasyonu, donma koruması, merkezi sıcaklık yönetimi.
