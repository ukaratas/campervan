# 🚐 Karavan Projesi - Iveco Daily Dönüşüm

Bu proje, Iveco Daily 18m³ tabanlı bir karavanın tüm sistemlerinin profesyonel, modüler ve otomasyona uygun şekilde tasarlanıp uygulanmasını dokümante eder.

## 🚗 Araç Bilgileri

### Temel Özellikler
- **Marka/Model**: Iveco Daily
- **Hacim**: 18m³
...
![Temel Yerleşim](Assets/Images/Temel.png)
...
- 🛏️ [**Ana Yatak Alanı**](Areas/main-bed.md): 200cm alan (araç boyunca), yatak altı depolama ve teknik ekipman alanı, 220V klima (Evacool Eva RV 2700 Premium) ve heki roof window ile otomasyon entegrasyonu.
- 🔝 [**Pull-down Yatak**](Areas/pull-down-bed.md): Şoför kabini üstü Lippert San Diego pull-down yatak, 24V aydınlatma ve USB-C soket.
...
- [x] Ana yatak alanı planlaması (200cm araç boyunca)
- [x] Pull-down yatak planlaması (Lippert San Diego, şoför kabini üstü)
...
│   ├── pull-down-bed.md       # Pull-down yatak (şoför kabini üstü)
...
│   ├── budget-management.md   # Bütçe yönetimi
...
│       └── Temel.png          # Temel yerleşim görseli
