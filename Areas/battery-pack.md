...
- **24V altyapı** ile karavanın tüm DC yükleri ve enerji yönetimi doğrudan beslenir. 12V gerektiren cihazlar için 24V to 12V DC konvertör ile ayrı bir 12V hat oluşturulur (Truma Combi 4D: 2-8A; Clesana C1: 0.05A standby, 0.5A flush; portatif cihazlar: 2-5A; toplam 12V yük: ~10A max).
...
| **Konvertör** | 24V to 12V DC Konvertör | 15-20A, yüksek verimli, 12V zorunlu cihazlar için (Truma Combi 4D: 2-8A; Clesana C1: 0.05A standby; portatif cihazlar) | 12V, 15-20A | $50-100 |
