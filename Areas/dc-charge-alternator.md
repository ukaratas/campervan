...
### İkincil Hedefler
* **Marş Aküsü Float Şarj**: Kampta park halindeyken 220V (inverter veya shore) üzerinden araç aküsünü float tutarak boşalmayı önlemek (araç ECU, merkezi kilit, alarm vb. parasitik yükler). Waveshare relay (Modbus) ile HA kontrolünde
...
- **Araç Aküsü Float**: HA otomasyonu araç aküsü voltajını izler, düşerse AC OUT 1 üzerinden Blue Smart IP65 beslemesini Waveshare relay toggle ile açar → araç aküsünü float modda tutar. Shore yokken de inverter üzerinden çalışır. Akü voltajı düşerse Bluetooth üzerinden uyarı gönder
